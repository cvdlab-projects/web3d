...
function init3D()
{
	...
	poly = plugins[0].getAllSets();
	renderItem = new RenderControl('web3d-ide-container',1024,768, poly , sliceSize);
    animate();
}

function RenderControl(tagName,width,height, polylines, size) {
